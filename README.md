...
└── credit_card_fraud_analysis/
    ...
    ├── Janak_CreditCardFraudAnalysis.ipynb  ← Jupyter Notebook analysis
    ├── Janak_ProjectReport.docx             ← Full project report (Word)
...
```bash
jupyter notebook Janak_CreditCardFraudAnalysis.ipynb
```
...
| File | Description |
|---|---|
| `Janak_CreditCardFraudAnalysis.ipynb` | Full notebook with 7 sections and 10+ charts |
| `app.py` | Streamlit web dashboard with 6 tabs and 15+ interactive charts |
| `Janak_ProjectReport.docx` | Formal project report in Microsoft Word format |
